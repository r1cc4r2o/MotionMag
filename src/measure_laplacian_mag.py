...
# motion magnification with eulerian video magnification
def laplacian_magnification(
        video, 
        alpha=200, 
        low=0.1, 
        high=0.2, 
    ...
    result[motion == 2] *= (alpha + amplification)
...
while cap.isOpened():
    ...
    if ret:
        # magnify the motion
        result = laplacian_magnification(frame)
